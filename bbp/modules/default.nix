...
let
    ...
    default_mpi_rdma = mvapich2-rdma;
        ...
        likwid = pkgs.envModuleGen rec {
            name = "likwid";
            moduleFilePrefix = "nix/hpc";

            isLibrary = true;
            description = "likwid module generated by nix";
            packages = [ pkgs.likwid ];
            conflicts = conflicts-modules;
        };
        ...
        spykfunc = pkgs.envModuleGen rec {
            ...
            packages = [ pkgs.spykfunc pkgs.parquet-converters pkgs.hadoop-bbp ];
        ...
        spykfunc-py3 = pkgs.envModuleGen rec {
            ...
            description = "spykfunc module generated by nix";
            packages = [ pkgs.spykfunc-py3 pkgs.parquet-converters pkgs.hadoop-bbp ];
        ...
        parquet-cpp = pkgs.envModuleGen rec {
            name = "parquet-cpp";
            moduleFilePrefix = "nix/hpc";
            isLibrary = true;

            description = "parquet module generated by nix";
            packages = [ pkgs.parquet-cpp ];
        };
        ...
        neurodamus-bare = pkgs.envModuleGen rec {
            name = "neurodamus-bare";
            moduleFilePrefix = "nix/hpc";
            setRoot = "NEURODAMUS";
            isLibrary = true;
            description = "neurodamus with 'scientific' modfiles removed from modlib";
            packages =
            [
                pkgs.neurodamus-bare
                pkgs.reportinglib
                pkgs.readline
                pkgs.ncurses
            ];
        ...
        bb5-utils = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages; ( getPyModRec [ bb5 ] );
        };
       ...
       blender = pkgs.envModuleGen rec {
        ...
        opencv = pkgs.envModuleGen rec {
                name = "opencv";
                moduleFilePrefix = "nix";
                setRoot = "OPENCV";
                isLibrary = true;
                description = "opencv module module generated by nix";
                packages = [
                    pkgs.opencv
                ];
        conflicts = conflicts-modules;
        ...
        rtneuron = pkgs.envModuleGen rec {
            ...
            packages = [
                            pkgs.rtneuron pkgs.equalizer
                       ];
            extraContent = "prepend-path LD_LIBRARY_PATH $targetEnv/lib/";
            dependencies = [ brion bbpsdk virtualgl pyqt5];
            conflicts = conflicts-modules;
        };
        ...
        ipython-py3 = pkgs.envModuleGen rec {
            ...
            description = "ipython module generated by nix";
            packages = with pkgs.python3Packages;
                       ( getPyModRec [ pkgs.python3Packages.ipython ] )
                       ++ ( getPyModRec [ pkgs.python3Packages.notebook ] )
                      ;
            conflicts = conflicts-modules ++ [ "ipython" ipython ];
        };


        python-opencv = pkgs.envModuleGen rec {
            name = "opencv";
            moduleFilePrefix = "nix/py27";
            isLibrary = true;
            ignoreCollisions = true;
            description = "ipython module generated by nix";
            packages = with pkgs.pythonPackages;
                       ( getPyModRec [ pkgs.pythonPackages.opencv ] )
                      ;
            conflicts = conflicts-modules;
        };

        python3-opencv = pkgs.envModuleGen rec {
            name = "opencv";
            moduleFilePrefix = "nix/py36";
            isLibrary = true;
            ignoreCollisions = true;
            description = "ipython module generated by nix";
            packages = with pkgs.python3Packages;
                       ( getPyModRec [ pkgs.python3Packages.opencv ] )
                      ;
            conflicts = conflicts-modules;
        };
        ...
        clang-analyzer = pkgs.envModuleGen rec {
            name = "clang-analyzer";
            version = "3.4";
            moduleFilePrefix = qa-prefix;
            description = "clang analyzer module generated by nix";
            packages = [ 
		pkgs.clang-analyzer
		pkgs.clang-tools
	    ];
       ...
       cuda9 = if (pkgs.nvidia-x11-default != null) then (pkgs.envModuleGen rec {
        ...
        tensorflow = pkgs.envModuleGen rec {
            ...
            packages = with pkgs.pythonPackages; ( getPyModRec [ tensorflowWithoutCuda ] ++ [add-site-dir] );
            extraContent = with pkgs.pythonPackages; ''
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithoutCuda.site-packages}
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithoutCuda.site-packages}/contrib/tensor_forest
            '';
            conflicts = [
                tensorflow-gpu
                tensorflow-py3
        ...
        tensorflow-gpu = if (pkgs.nvidia-drivers != null) then (pkgs.envModuleGen rec {
            name = "tensorflow-gpu";
            moduleFilePrefix = "nix/py27";
            setRoot = "TENSORFLOW";
            description = "tensorflow module generated by nix";
            packages = with pkgs.pythonPackages; ( getPyModRec [ tensorflowWithCuda ] ++ [add-site-dir] );
            extraContent = with pkgs.pythonPackages; ''
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithCuda.site-packages}
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithCuda.site-packages}/contrib/tensor_forest
            '';
            conflicts = [
                tensorflow
                tensorflow-py3
        ...
        tensorflow-py3 = pkgs.envModuleGen rec {
            ...
            setRoot = "TENSORFLOW";
            description = "tensorflow module generated by nix";
            packages = with pkgs.python3Packages; ( getPyModRec [ tensorflowWithoutCuda ] ++ [add-site-dir] );
            extraContent = with pkgs.pythonPackages; ''
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithoutCuda.site-packages}
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithoutCuda.site-packages}/contrib/tensor_forest
            '';
        ...
        tensorflow-gpu-py3 = if (pkgs.nvidia-drivers != null) then (pkgs.envModuleGen rec {
            name = "tensorflow-gpu";
            moduleFilePrefix = "nix/py36";
            setRoot = "TENSORFLOW";
            description = "tensorflow module generated by nix";
            packages = with pkgs.python3Packages; ( getPyModRec [ tensorflowWithCuda ] ++ [add-site-dir] );
            extraContent = with pkgs.pythonPackages; ''
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithCuda.site-packages}
                prepend-path LD_LIBRARY_PATH $targetEnv/${tensorflowWithCuda.site-packages}/contrib/tensor_forest
            '';
        ...
        keras-py3 = pkgs.envModuleGen rec {
                name = "keras";
                moduleFilePrefix = "nix/py36";
                description = "keras module generated by nix";
                packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.python3Packages.Keras ] );
        };
        ...
        pyyaml = pkgs.envModuleGen rec {
                name = "pyyaml";
                moduleFilePrefix = "nix/py27";
                description = "pyymal module generated by nix";
                packages = with pkgs.pythonPackages; ( getPyModRec [ pkgs.pythonPackages.pyyaml ] );
        };

        pyyaml-py3 = pkgs.envModuleGen rec {
                name = "pyyaml";
                moduleFilePrefix = "nix/py36";
                description = "pyymal module generated by nix";
                packages = with pkgs.python3Packages; ( getPyModRec [ pkgs.python3Packages.pyyaml ] );
        };
        ...
        nano = pkgs.envModuleGen rec {
                name = "nano";
                description = "nano module generated by nix";
                packages = [ pkgs.nano ];
        };
